...
public class LanguageResourceIntTest {
    ...
    private static final LanguageCode DEFAULT_CODE = LanguageCode.FRENCH;
    private static final LanguageCode UPDATED_CODE = LanguageCode.ENGLISH;
    ...
    public void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.getComment()).isEqualTo(DEFAULT_COMMENT);
    ...
    public void updateLanguage() throws Exception {
        ...
        assertThat(testLanguage.getComment()).isEqualTo(UPDATED_COMMENT);
